...
CLIENT_GREETING = (
    "Здравствуйте! 👋\n"
    "Я менеджер компании <b>«Мир Стекла»</b> — помогу подобрать "
    "стеклянную перегородку под ваше помещение.\n\n"
    "<b>Чем я могу быть полезен:</b>\n"
    "• общаюсь на <b>русском, кыргызском и английском</b> — пишите как удобно;\n"
    "• принимаю как <b>текстовые, так и голосовые</b> сообщения;\n"
    "• помогу выбрать форму (прямая / Г-образная / П-образная), размеры, "
    "тип стекла, цвет профиля, матировку и ручку;\n"
    "• создам <b>3D-визуализацию</b> вашей будущей перегородки с разных ракурсов;\n"
    "• рассчитаю <b>ориентировочную стоимость</b>;\n"
    "• покажу <b>примеры реальных работ</b> нашей мастерской;\n"
    "• <b>запишу на замер</b> — мастер приедет в удобное вам время.\n\n"
    "Опишите, какую перегородку вы хотите — куда, какой примерно размер, "
    "какой стиль. Можно прямо сейчас текстом или голосом."
)

CLIENT_COMMANDS = {
    "/start": CLIENT_GREETING,
    "/help": CLIENT_GREETING,
    "/examples": (
        "Примеры запросов:\n"
        "• «Прямая перегородка шириной 3 м, высота 2.7 м, чёрный профиль, прозрачное стекло»\n"
        "• «Г-образная 2.5 на 1.2 м, рифленое стекло, бронзовый профиль»\n"
        "• «Хочу замер завтра в 15:30»\n"
        "• Голосовое сообщение — тоже подойдёт, просто опишите своими словами."
    ),
}
