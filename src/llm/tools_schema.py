...
1. render_partition — создать 3D-рендер и расчёт стоимости
   ...
   Нумерация секций: на основной/front стене слева направо, если стоять перед перегородкой; на боковых стенах от угла соединения с основной стеной наружу.
...
2. schedule_measurement — записать клиента на замер
   ...
   - address: адрес
   ПРАВИЛА:
   - Без адреса НЕ записывай на замер, сначала спроси адрес.
   - Замеры доступны с 09:00 до 19:00, воскресенье выходной.
   - Клиент может предложить любое время с шагом 15 минут; система проверит, что рядом нет активного замера ближе 45 минут.
